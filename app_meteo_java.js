...
const template = "https://api.geoapify.com/v1/geocode/search?apiKey=5e8d464f7a6f48f281288c93c1531355&text=%COUNTRY";
...
button.onclick = () => {
    const luogo=LuogoInput.value;
    let url = template.replace("%COUNTRY", luogo);
    fetch(url)
